  ...
  return (
    <section  className='max-w-7xl mx-auto p-8'>
      ...
      <p className='text-lg text-grey-700'>
        ...
        website using React, TypeScript and Tailwind CSS. Outside of coding, I stay active with running and cycling, and continuously expand my knowledge by learning
